...
.sx-float-btn {
  ...
  width: 5.625rem;  /* ×3 AREA (not ×3 diameter): 3.25rem × √3 ≈ 90px */
  height: 5.625rem;
  border-radius: 50%;
  color: #fff;
...
.sx-float-btn.is-zalo {
  ...
  font-weight: 800;
  font-size: 1.4rem;   /* scaled to the 90px button */
...
@media (max-width: 767px) {
  .sx-float-btn { width: 4rem; height: 4rem; } /* mobile: 64px (~1.5× area), smaller than desktop */
  .sx-float-btn.is-zalo { font-size: 1rem; }
